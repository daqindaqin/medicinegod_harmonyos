...
public class DespProvider extends BaseItemProvider {

    private List<Map<String, Object>> list;
    private AbilitySlice slice;

    public DespProvider(List<Map<String, Object>> list, AbilitySlice slice) {
        this.list = list;
        this.slice = slice;
    }
    ...
    public Component getComponent(int position, Component convertComponent, ComponentContainer componentContainer) {
        ...
        if (convertComponent == null) {
            ...
            cpt = LayoutScatter.getInstance(slice).parse(ResourceTable.Layout_list_item_search_method_desp, null, false);
        } else {
...
*/
        ...
        Text textDesp = (Text) cpt.findComponentById(ResourceTable.Id_srced_desp);
        ...
        if (map.get("keyid") != null) {
            ...
            textDesp.setText("        " + (String) map.get("description"));
